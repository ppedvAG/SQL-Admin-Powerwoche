...
SET @BackupDirectory     = N'C:\_Backup' -- Specify the backup root directory.
SET @CleanupTime         = 120         -- Time in hours, after which backup files are deleted. If no time is specified, then no backup files are deleted.
SET @OutputFileDirectory = N'C:\_Backup'         -- Specify the output file directory. If no directory is specified, then the SQL Server error log directory is used.
